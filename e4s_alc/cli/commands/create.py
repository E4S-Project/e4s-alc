...
class CreateCommand(AbstractCommand):
    ...
    def create_subparser(self, subparsers):
        ...
        spack_group_args.add_argument('-me', '--modules-env-file', help='The path to a modules.yaml environment file', dest='modules-env-file')
        ...
        spack_group_args.add_argument('-se', '--spack-env-file', help='The path to a spack.yaml environment file', dest='spack-env-file')
